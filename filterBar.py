#!/usr/bin/env python
# filterBar.py
# 6/23/2014 Sarah J. Spencer, Alm Lab
# Filter Illumina sequence reads for matches to synthetic barcode primer
# structure.
# NOTE: formatted for use on the coyote cluster.
...
# Parse the forward read for known primer sequence structure
# Output: sequences that match the known structure
